                              ...
                              <div class="form-row">
                                  ...
                                  <div class="mt-2 form-group col-md-6">
                                      ...
                                      <div class="mb-2 input-group mr-sm-2">
                                          ...
                                          <input type="number" name="previous_price" class="form-control" placeholder="Current Price of item">
                                      </div>
                                  </div>
                                  <div class="mt-2 form-group col-md-6">
                                  ...
                                  <div class="mt-2 form-group col-md-6">
                                      ...
                                      <input type="text" name="videolink" class="shadow-sm form-control">
                                  </div>
                                  <div class="mt-2 form-group col-md-6">
                                  ...
                                  <div class="mt-2 form-group col-md-12">
                                      ...
                                      <textarea name="description" id="mytextarea" rows="5" class="shadow-sm form-control"></textarea>
                                  </div>
