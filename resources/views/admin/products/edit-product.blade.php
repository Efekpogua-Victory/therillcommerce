                          ...
                          <form action="{{route('admin.updateproduct')}}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id" value="{{$product->id}}">
                              <div class="form-row">
                                  ...
                                  <div class="col-md-6">
                                      <img src="{{asset('storage/images/'. $product->featured_image)}}" alt="" class="w-50">
                                  </div>
                                  ...
                                  <div class="mt-2 form-group col-md-6">
                                      ...
                                      <input type="text" value="{{$product->videolink}}" name="videolink" class="shadow-sm form-control">
                                  </div>
                                  <div class="mt-2 form-group col-md-6">
                                  ...
                                  <div class="mt-2 form-group col-md-12">
                                      ...
                                      <textarea name="description" id="mytextarea" rows="5" class="shadow-sm form-control">{{$product->description}}</textarea>
                                  </div>
