...
<head>
    ...
    <title>Shopme - @yield('title') </title>
    <link rel="apple-touch-icon" href="{{asset('dash/dash/app-assets/images/ico/apple-icon-120.html')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('dash/dash/app-assets/images/ico/apple-icon-120.html')}}">
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2020 drop it</span></p>
    </footer>
