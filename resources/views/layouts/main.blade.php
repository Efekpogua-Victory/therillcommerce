...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="app/images/icons/favicon.png">
    @section('styles')
    <script>
        WebFontConfig = {
            google: {
...
<body>
                ...
                <div class="container">
                    <div class="w-auto pl-0 header-left col-lg-2">
                        ...
                        <a href="{{route('home')}}" class="logo">
                            <img src="{{asset('app/images/logo.png')}}" width="111" height="44" alt="{{$settings->site_name}}}">
                        </a>
                    </div>
                    <!-- End .header-left -->
                    ...
                    <div class="header-right w-lg-max">
                        <div class="mt-0 text-right header-icon header-search header-search-inline header-search-category w-lg-max">
                            ...
                            <form action="javascript:void(0)" method="GET" id="searchform" class="searchform">
                                ...
                                <div class="header-search-wrapper">
                                    <input type="search" class="form-control" name="q" id="searchitem" placeholder="Search..." required>
                                    <!-- End .select-custom -->
                        ...
                        <div class="pl-4 pr-4 header-contact d-none d-lg-flex">
                            <img alt="phone" src="{{asset('app/images/phone.png')}}" width="30" height="30" class="pb-1">
                            <h6><span>Call us now</span><a href="tel:{{$settings->contact_phone}}" class="text-dark font1">{{$settings->contact_phone}}</a></h6>
                        </div>

                        <a href="{{route('login')}}" class="header-icon" title="login"><i class="icon-user-2"></i></a>

                        <a href="{{route('user.wishlist')}}" class="header-icon" title="wishlist"><i class="icon-wishlist-2"></i></a>
                    ...
                    <nav class="main-nav w-100">
                        <ul class="menu">
                            ...
                            <li class="{{ (request()->routeIs('products')) ? 'active' : '' }}">
                                <a href="{{route('products', ['cat'=>'all', 'brand' => 'all', 'st' => 'desc', 'pg' => 10, 'search'=> 'query'])}}">Products</a>
                            </li>
                    ...
                    <div class="row">
                        <div class="pb-2 col-sm-4 pb-sm-0">
                            <div class="widget">
                                ...
                                <a href="{{route('home')}}">
                                    <img src="{{asset('app/images/logo-footer.png')}}" alt="Logo" class="logo-footer">
                                </a>
                        ...
                        <div class="col-lg-4 col-sm-4">
                            <div class="widget">
                                ...
                                <ul class="contact-info">
                                    ...
                                    <li>
                                        <span class="contact-info-label">Phone:</span><a href="tel:{{$settings->contact_phone}}">{{$settings->contact_phone}}</a>
                                    </li>
                                    <li>
                                        <span class="contact-info-label">Email:</span> <a href="mailto:{{$settings->contact_email}}">{{$settings->contact_email}}</a>
                                    </li>
                                    <li>
                ...
                <div class="footer-bottom">
                    <div class="container d-sm-flex align-items-center">
                        <div class="footer-left">
                            <span class="footer-copyright">© {{$settings->site_name}}. {{date('y')}}. All Rights Reserved</span>
                        </div>
    ...
    <div class="mobile-menu-container">
        <div class="mobile-menu-wrapper">
            ...
            <form class="mb-2 search-wrapper" action="javascript:void(0)" method="GET" id="mobilesearchform" >
                @csrf
                <input type="text" class="mb-0 form-control" id="mobileitemsearch" placeholder="Search..." required />
    ...
    <div class="sticky-navbar">
        ...
        <div class="sticky-info">
            <a href="{{route('products', ['cat'=>'all', 'brand' => 'all', 'st' => 'desc', 'pg' => 10, 'search'=> 'query'])}}" class="">
        ...
        <script>
           ...
           let searchitemvalue = document.getElementById('mobileitemsearch');
            ...
            function searchprod (event){
                ...
                let url = "{{url('/products/category:/all/brand:/all/sort:/desc/paginate:/10/query:/')}}"+ '/' + query.value;
            ...
            function mobilesearch (event){
                ...
                let url = "{{url('/products/category:/all/brand:/all/sort:/desc/paginate:/10/query:/')}}"+ '/' + searchitemvalue.value;
                window.location.href = url;
            }
        </script>
    @show
