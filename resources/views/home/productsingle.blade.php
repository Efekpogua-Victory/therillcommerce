        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 product-single-gallery">
                <div class="product-slider-container">
                        ...
                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                            @foreach ($images as $image)
                                <div class="product-item">
                                    <img class="product-single-image" src="{{asset('storage/images/'. $image->img_file)}}" data-zoom-image="{{asset('storage/images/'. $image->img_file)}}" width="468" height="468" alt="product" />
                                </div> 
                            @endforeach
                        </div> 
                    @else
                    <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                        <div class="product-item">
                            <img class="product-single-image" src="{{asset('storage/images/'. $product->featured_image)}}" data-zoom-image="{{asset('storage/images/'. $product->featured_image)}}" width="468" height="468" alt="product" />
                        </div> 
                    </div> 
                    @endif
                ...
                <div class="prod-thumbnail owl-dots">
                    @foreach ($images as $image)
                        ...
                        <div class="owl-dot">
                            <img src="{{asset('storage/images/'. $image->img_file)}}" width="110" height="110" alt="product-thumbnail" />
                        </div>
